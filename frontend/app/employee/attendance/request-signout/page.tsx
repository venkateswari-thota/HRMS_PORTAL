...
export default function RequestSignOutPage() {
    const router = useRouter();
    const [reason, setReason] = useState('');
    const [currentLoc, setCurrentLoc] = useState({ lat: 0, lng: 0 });
    const [statusMsg, setStatusMsg] = useState('');
    const [requestType, setRequestType] = useState('CHECK_OUT');
    ...
    return (
        <div className="max-w-2xl mx-auto my-10 p-8 bg-white rounded-3xl shadow-2xl border border-red-50">
            <div className="text-center mb-8">
                ...
                <p className="text-gray-500 font-medium">Checkout Verification Required</p>
            </div>
            ...
            <div className="space-y-8">
                ...
                <div className="space-y-2">
                    ...
                    <textarea
                        ...
                        placeholder="e.g. Forgot to punch out, Device out of battery, client site visit..."
