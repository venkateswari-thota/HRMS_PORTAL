                ...
                <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
                    ...
                    <div className="lg:col-span-1 space-y-6">
                        <Link href="/admin/employees" className="block group">
                            <div className="bg-white p-8 rounded-[2.5rem] border border-gray-100 shadow-sm hover:shadow-2xl hover:-translate-y-1 transition-all duration-500 relative overflow-hidden flex flex-col justify-center border-l-8 border-l-blue-600">
                        ...
                        <Link href="/admin/locations" className="block group">
                            <div className="bg-white p-8 rounded-[2.5rem] border border-gray-100 shadow-sm hover:shadow-2xl hover:-translate-y-1 transition-all duration-500 relative overflow-hidden flex flex-col justify-center border-l-8 border-l-rose-500 aspect-square">
                                ...
                                <div className="relative z-10 space-y-4">
                                    ...
                                    <div>
                                        <p className="text-[10px] font-black text-gray-400 uppercase tracking-widest mb-1">Geographic Assets</p>
                                        <h3 className="text-2xl font-black text-gray-900 leading-tight">
                                            Work Locations
                                        </h3>
                                    </div>
                                    <div className="flex items-center gap-2 text-xs font-bold text-rose-600 underline">
                                        Manage Zones <ChevronRight size={14} />
                                    </div>
                                </div>
                            </div>
                        </Link>
