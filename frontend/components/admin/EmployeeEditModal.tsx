...
import { X, Shield, MapPin, Clock, Mail, AlertCircle, Edit2, Phone, MapPin as MapPinIcon } from 'lucide-react';
                ...
                <div className="flex-1 overflow-y-auto p-10 space-y-8">
                    <form id="edit-form" onSubmit={handleSave} className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <div className="space-y-1">
                            ...
                            <input
                                className={`${inputClass} ${fieldErrors.primary_phone ? 'border-red-500 bg-red-50 focus:border-red-500 focus:ring-red-500' : ''}`}
                            ...
                            {fieldErrors.primary_phone && (
                                <p className="text-[11px] text-red-500 font-medium flex items-center gap-1 mt-1">
                                    <AlertCircle size={10} /> {fieldErrors.primary_phone}
                                </p>
                            )}
                        </div>
                        ...
                        <div className="space-y-1">
                            ...
                            <input
                                className={`${inputClass} ${fieldErrors.secondary_phone ? 'border-red-500 bg-red-50 focus:border-red-500 focus:ring-red-500' : ''}`}
                            ...
                            {fieldErrors.secondary_phone && (
                                <p className="text-[11px] text-red-500 font-medium flex items-center gap-1 mt-1">
                                    <AlertCircle size={10} /> {fieldErrors.secondary_phone}
                                </p>
                            )}
                        </div>

                        <div className="space-y-1">
                            <label className="text-xs font-bold text-gray-500 uppercase tracking-wide flex items-center gap-2 text-red-500/80">
                                <AlertCircle size={14} />
                                Emergency Phone
                            </label>
                            <input
                                className={`${inputClass} ${fieldErrors.emergency_phone ? 'border-red-500 bg-red-50 focus:border-red-500 focus:ring-red-500' : ''}`}
                            ...
                            {fieldErrors.emergency_phone && (
                                <p className="text-[11px] text-red-500 font-medium flex items-center gap-1 mt-1">
                                    <AlertCircle size={10} /> {fieldErrors.emergency_phone}
                                </p>
                            )}
                        </div>

                        <div className="space-y-1">
                            <label className="text-xs font-bold text-gray-500 uppercase tracking-wide flex items-center gap-2 text-rose-500">
                                <MapPinIcon size={14} />
                                Work Location
                                {locationsLoading && <span className="text-[10px] lowercase animate-pulse text-blue-400 font-normal">(fetching...)</span>}
                            </label>
                            <select
                                className={`${inputClass} appearance-none cursor-pointer ${locationsError ? 'border-red-200 bg-red-50/10' : ''}`}
